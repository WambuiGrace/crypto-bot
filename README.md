This Python script tracks the prices of specific cryptocurrencies using the CoinGecko API and sends notifications via a Telegram bot when the prices meet predefined targets.
